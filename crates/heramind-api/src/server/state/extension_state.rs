...
//! - **Crash safety**: Extension crashes don't affect the main HeraMind process
...
use heramind_core::extension::registry::ExtensionRegistry;
use heramind_core::extension::{ExtensionRuntime, ExtensionRuntimeConfig};

// Import ExtensionStore for loading persisted extensions
pub use heramind_storage::extensions::ExtensionStore;
...
pub struct ExtensionMetricsStorage {
    ...
    inner: Arc<heramind_devices::TimeSeriesStorage>,
}
...
impl ExtensionMetricsStorage {
    ...
    pub fn with_shared_storage(storage: Arc<heramind_devices::TimeSeriesStorage>) -> Self {
        Self { inner: storage }
    }
    ...
    pub fn open(path: &std::path::Path) -> Result<Self, String> {
        let storage = heramind_devices::TimeSeriesStorage::open(path)
    ...
    pub fn memory() -> Result<Self, String> {
        let storage = heramind_devices::TimeSeriesStorage::memory()
    ...
    pub async fn write(
        ...
        source_id: &str,
        metric: &str,
        data_point: heramind_devices::telemetry::DataPoint,
    ) -> Result<(), String> {
        self.inner
    ...
    ) -> Result<Vec<heramind_devices::telemetry::DataPoint>, String> {
        self.inner
    ...
    pub async fn query_latest(
        ...
        source_id: &str,
        metric: &str,
    ) -> Result<Option<heramind_devices::telemetry::DataPoint>, String> {
        self.inner
...
impl ExtensionState {
    ...
    pub fn get_event_dispatcher(&self) -> Option<Arc<heramind_core::extension::EventDispatcher>> {
    ...
    pub async fn set_capability_provider(
        &self,
        provider: Arc<dyn heramind_core::extension::context::ExtensionCapabilityProvider>,
    ) {
    ...
    pub async fn minimal() -> Self {
        ...
        let temp_dir = std::env::temp_dir().join(format!("heramind_test_{}", std::process::id()));
...
// ============================================================================
// Adapter for heramind_rules ExtensionRegistry
// ============================================================================

/// Adapter that implements heramind_rules::ExtensionRegistry for ExtensionRuntime.
...
impl heramind_rules::extension_integration::ExtensionRegistry for ExtensionRegistryAdapter {
...
mod tests {
    ...
    async fn test_extension_storage_write_query() {
        ...
        // Write a data point
        let point = heramind_devices::telemetry::DataPoint::new(
            1234567890,
            heramind_devices::mdl::MetricValue::Float(42.5),
        );
