    ...
    for (idx, result) in results {
        if let Ok(Some(data_point)) = result {
            ...
            let value = match &data_point.value {
                heramind_devices::mdl::MetricValue::Float(v) => serde_json::json!(v),
                heramind_devices::mdl::MetricValue::Integer(v) => serde_json::json!(v),
                heramind_devices::mdl::MetricValue::Boolean(v) => serde_json::json!(v),
                heramind_devices::mdl::MetricValue::String(v) => serde_json::json!(v),
                heramind_devices::mdl::MetricValue::Array(v) => serde_json::json!(v),
                heramind_devices::mdl::MetricValue::Binary(_) => serde_json::json!("<binary>"),
                heramind_devices::mdl::MetricValue::Null => serde_json::Value::Null,
            };
            source.current_value = Some(value);

            if source.data_type == "unknown" {
                source.data_type = match &data_point.value {
                    heramind_devices::mdl::MetricValue::Float(_) => "float".to_string(),
                    heramind_devices::mdl::MetricValue::Integer(_) => "integer".to_string(),
                    heramind_devices::mdl::MetricValue::Boolean(_) => "boolean".to_string(),
                    heramind_devices::mdl::MetricValue::String(_) => "string".to_string(),
                    heramind_devices::mdl::MetricValue::Array(_) => "array".to_string(),
                    heramind_devices::mdl::MetricValue::Binary(_) => "binary".to_string(),
                    heramind_devices::mdl::MetricValue::Null => "null".to_string(),
                };
            }
        }
    }
