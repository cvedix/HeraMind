    ...
    DeviceInstance {
        ...
        status: match status {
            MdlConnectionStatus::Disconnected => {
                heramind_devices::mdl_format::ConnectionStatus::Disconnected
            }
            ...
            MdlConnectionStatus::Error => heramind_devices::mdl_format::ConnectionStatus::Error,
        },
        last_seen,
...
pub fn device_type_to_template(def: &DeviceTypeDefinition) -> DeviceTypeTemplate {
    DeviceTypeTemplate {
        ...
        mode: heramind_devices::registry::DeviceTypeMode::Full,
...
pub fn template_to_device_type(template: &DeviceTypeTemplate) -> DeviceTypeDefinition {
    DeviceTypeDefinition {
        ...
        mode: heramind_devices::mdl_format::DeviceTypeMode::Full,
...
pub fn format_status_to_mdl(
    status: &heramind_devices::mdl_format::ConnectionStatus,
) -> MdlConnectionStatus {
    use heramind_devices::mdl_format::ConnectionStatus;
    match status {
