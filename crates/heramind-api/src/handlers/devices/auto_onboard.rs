    ...
    match OllamaRuntime::new(config) {
        ...
        Err(_) => {
            ...
            impl LlmRuntime for DummyRuntime {
                ...
                fn capabilities(&self) -> heramind_core::llm::backend::BackendCapabilities {
                ...
                > {
                    Ok(heramind_core::llm::backend::LlmOutput {
                        text: String::new(),
                        thinking: None,
                        finish_reason: heramind_core::llm::backend::FinishReason::Stop,
                        usage: Some(heramind_core::llm::backend::TokenUsage::new(0, 0)),
                        tool_calls: None,
                    })
                }
...
fn convert_metrics_to_template(metrics: &[DiscoveredMetric]) -> Vec<MetricDefinition> {
    use crate::automation::SemanticType;
    use heramind_devices::MetricDataType;
