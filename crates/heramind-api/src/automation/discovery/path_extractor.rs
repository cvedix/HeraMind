...
use super::types::*;
use heramind_core::{llm::backend::LlmInput, GenerationParams, LlmRuntime, Message};
...
mod tests {
    ...
    impl heramind_core::llm::backend::LlmRuntime for MockLlm {
        fn backend_id(&self) -> heramind_core::llm::backend::BackendId {
            heramind_core::llm::backend::BackendId::new("mock")
        }
    ...
    use futures::Stream;
    use heramind_core::llm::backend::StreamChunk;
    use std::pin::Pin;
