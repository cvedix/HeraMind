//! Macros for HeraMind Extension SDK
//!
//! This module provides macros to simplify extension development.

/// Export FFI functions for an extension type
///
/// This macro generates all necessary FFI exports for a HeraMind extension.
...
/// ```
#[macro_export]
macro_rules! heramind_export {
    // Simple case: just the type name
    ($extension_type:ty) => {
        $crate::heramind_export_with_constructor!($extension_type, new);
    };
}
...
///
/// ```rust,ignore
/// heramind_export_with_constructor!(MyExtension, with_config);
/// ```
#[macro_export]
macro_rules! heramind_export_with_constructor {
    ($extension_type:ty, $constructor:ident) => {
        // Native FFI exports
        #[cfg(not(target_arch = "wasm32"))]
        mod __heramind_ffi_exports {
            use super::*;

            #[no_mangle]
            pub extern "C" fn heramind_extension_abi_version() -> u32 {
            ...
            #[no_mangle]
            pub extern "C" fn heramind_extension_metadata() -> $crate::CExtensionMetadata {
                use std::ffi::CStr;
            ...
            #[no_mangle]
            pub extern "C" fn heramind_extension_reset_instance() {
                let mut guard = EXTENSION_INSTANCE.write().unwrap();
                *guard = None;
            }
            ...
            #[no_mangle]
            pub extern "C" fn heramind_extension_free_string(ptr: *mut std::os::raw::c_char) {
                if !ptr.is_null() {
            ...
            #[no_mangle]
            pub extern "C" fn heramind_extension_set_capability_bridge(
            ...
            #[no_mangle]
            pub extern "C" fn heramind_extension_descriptor_json() -> *mut std::os::raw::c_char {
            ...
            #[no_mangle]
            pub extern "C" fn heramind_extension_execute_command_json(
                input_ptr: *const u8,
                input_len: usize,
            ...
            #[no_mangle]
            pub extern "C" fn heramind_extension_configure_json(
                input_ptr: *const u8,
                input_len: usize,
            ) -> *mut std::os::raw::c_char {
                let input = match parse_input_json(input_ptr, input_len) {
            ...
            #[no_mangle]
            pub extern "C" fn heramind_extension_produce_metrics_json() -> *mut std::os::raw::c_char {
                let instance = extension_instance().clone();
                match block_on_result(async move {
                    let ext = instance.read().await;
            ...
            #[no_mangle]
            pub extern "C" fn heramind_extension_health_check_json() -> *mut std::os::raw::c_char {
                let instance = extension_instance().clone();
                match block_on_result(async move {
                    let ext = instance.read().await;
            ...
            #[no_mangle]
            pub extern "C" fn heramind_extension_stats_json() -> *mut std::os::raw::c_char {
                let instance = extension_instance().clone();
                match block_on_result(async move {
                    let ext = instance.read().await;
                    Ok::<serde_json::Value, String>(serde_json::json!({
            ...
            #[no_mangle]
            pub extern "C" fn heramind_extension_event_subscriptions_json() -> *mut std::os::raw::c_char {
                let instance = extension_instance().clone();
                match block_on_result(async move {
                    let ext = instance.read().await;
            ...
            #[no_mangle]
            pub extern "C" fn heramind_extension_stream_capability_json() -> *mut std::os::raw::c_char {
                let instance = extension_instance().clone();
                match block_on_result(async move {
                    let ext = instance.read().await;
                    Ok::<serde_json::Value, String>(serde_json::json!({
            ...
            #[no_mangle]
            pub extern "C" fn heramind_extension_init_session_json(
                input_ptr: *const u8,
                input_len: usize,
            ) -> *mut std::os::raw::c_char {
                let input = match parse_input_json(input_ptr, input_len) {
            ...
            #[no_mangle]
            pub extern "C" fn heramind_extension_process_session_chunk_json(
                input_ptr: *const u8,
                input_len: usize,
            ) -> *mut std::os::raw::c_char {
                let input = match parse_input_json(input_ptr, input_len) {
            ...
            #[no_mangle]
            pub extern "C" fn heramind_extension_close_session_json(
                input_ptr: *const u8,
                input_len: usize,
            ) -> *mut std::os::raw::c_char {
                let input = match parse_input_json(input_ptr, input_len) {
            ...
            #[no_mangle]
            pub extern "C" fn heramind_extension_process_chunk_json(
                input_ptr: *const u8,
                input_len: usize,
            ) -> *mut std::os::raw::c_char {
                let input = match parse_input_json(input_ptr, input_len) {
            ...
            #[no_mangle]
            pub extern "C" fn heramind_extension_start_push_json(
                input_ptr: *const u8,
                input_len: usize,
            ) -> *mut std::os::raw::c_char {
                let input = match parse_input_json(input_ptr, input_len) {
            ...
            #[no_mangle]
            pub extern "C" fn heramind_extension_stop_push_json(
                input_ptr: *const u8,
                input_len: usize,
            ) -> *mut std::os::raw::c_char {
                let input = match parse_input_json(input_ptr, input_len) {
            ...
            #[no_mangle]
            pub extern "C" fn heramind_extension_handle_event_json(
                input_ptr: *const u8,
                input_len: usize,
            ) -> *mut std::os::raw::c_char {
                let input = match parse_input_json(input_ptr, input_len) {
            ...
            #[no_mangle]
            pub extern "C" fn heramind_extension_register_push_writer(
...
/// heramind_extension!(MyExtension {
///     id: "my-extension",
///     name: "My Extension",
///     version: "1.0.0",
...
/// ```
#[macro_export]
macro_rules! heramind_extension {
    (
        $extension_type:ty {
            id: $id:literal,
            name: $name:literal,
                    ...
                    $(
                        $(
                            $crate::MetricDescriptor {
                                ...
                                data_type: $crate::heramind_extension_metric_type!($metric_type),
                                unit: String::new(),
                                min: None,
                                max: None,
                                required: false,
                                ...
                                parameters: vec![
                                    $(
                                        $crate::ParameterDefinition {
                                            ...
                                            description: String::new(),
                                            param_type: $crate::heramind_extension_param_type!($param_type),
                                            required: true,
                                            default_value: None,
                                            min: None,
                                            max: None,
        ...
        // Export FFI functions
        $crate::heramind_export!($extension_type);
    };
}

/// Helper macro to convert type name to MetricDataType
#[macro_export]
macro_rules! heramind_extension_metric_type {
    (Float) => {
...
#[macro_export]
macro_rules! heramind_extension_param_type {
    (Float) => {
        $crate::MetricDataType::Float
    };
    (Integer) => {
...
///
/// This macro is a simplified version of `heramind_extension!` that only requires
/// the essential fields. Use this when you don't need metrics or complex commands.
///
/// # Example
///
/// ```rust,ignore
/// heramind_simple_extension!(MyExtension {
///     id: "my-extension",
///     name: "My Extension",
///     version: "1.0.0",
///
...
/// ```
#[macro_export]
macro_rules! heramind_simple_extension {
    (
        $extension_type:ty {
            id: $id:literal,
            name: $name:literal,
        ...
        vec![
            $(
                $crate::MetricDescriptor {
                    ...
                    data_type: $crate::heramind_extension_metric_type!($type),
    ...
    ($name:literal : $display:literal : $type:ident $(, $rest:tt)*) => {
        {
            let mut params = vec![
                $crate::ParameterDefinition {
                    ...
                    display_name: $display.to_string(),
                    description: String::new(),
                    param_type: $crate::heramind_extension_param_type!($type),
                    required: true,
                    default_value: None,
                    min: None,
                    max: None,
