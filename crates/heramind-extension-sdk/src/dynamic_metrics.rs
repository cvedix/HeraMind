...
//!
//! Many HeraMind extensions track multiple parallel instances at runtime:
...
//!
//! ```rust,ignore
//! use heramind_extension_sdk::dynamic_metrics::{
//!     DynamicMetricsRegistry, MetricTemplate,
//! };
//! use heramind_extension_sdk::{MetricDataType, MetricValue};
//!
