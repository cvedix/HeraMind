...
/// providing complete isolation from the main HeraMind process.
...
impl IsolatedExtensionManager {
    ...
    ///
    /// When HeraMind crashes or is force-killed, child `heramind-extension-runner`
    ...
    pub fn cleanup_orphaned_runners() {
        ...
        #[cfg(unix)]
        {
            ...
            // Edge case: when HeraMind itself runs as PID 1 (container init
            ...
            // *any* HeraMind instance on this host have their spawning HeraMind
            // process as the parent (not init), so they are untouched — this
            // fixes the previous `pkill -f heramind-extension-runner` behavior
            ...
            for &pid in &candidate_pids {
                ...
                // (another HeraMind instance, an interactive shell, etc.).
                // Leave alone.
            }
        ...
        #[cfg(windows)]
        {
            ...
            // exists. Live runners of ANY HeraMind instance on this host have
