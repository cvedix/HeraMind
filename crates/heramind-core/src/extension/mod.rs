//! Extension system for HeraMind (V2).
//!
//! Extensions are isolated modules (.so/.dylib/.dll/.wasm) that extend
//! HeraMind's capabilities. They are distinct from user configurations like
...
//! - Extension crashes don't affect main HeraMind process
