...
fn test_parse_extension_package() {
    ...
    let package_path =
        Path::new("/Users/shenmingming/HeraMind-Extension/heramind.weather.forecast.wasm-0.5.9.nep");
    ...
    // assert_eq!(package.manifest.format, "heramind-extension-package");
}

#[test]
fn test_detect_platform() {
    use heramind_core::extension::package::detect_platform;
