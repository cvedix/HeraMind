...
use heramind_core::extension::event_dispatcher::EventDispatcher;
use heramind_core::extension::event_subscription::{EventFilter, EventSubscription};
...
async fn test_event_bus_publish() {
    ...
    let event = HeraMindEvent::DeviceMetric {
        ...
        value: heramind_core::event::MetricValue::Float(25.5),
