...
//! - Automatic event conversion for all HeraMindEvent types
...
impl Extension for DeviceEventExtension {
    ...
    fn metrics(&self) -> Vec<heramind_core::extension::system::MetricDescriptor> {
        vec![]
    }

    fn commands(&self) -> Vec<heramind_core::extension::system::ExtensionCommand> {
        vec![]
    }
...
async fn test_extension_event_subscription_wildcard() {
    ...
    event_bus
        .publish(HeraMindEvent::RuleTriggered {
    ...
    event_bus
        .publish(HeraMindEvent::AgentExecutionStarted {
...
async fn test_extension_event_subscription_prefix_match() {
    ...
    event_bus
        .publish(HeraMindEvent::AgentThinking {
            agent_id: "agent1".to_string(),
            execution_id: "exec1".to_string(),
            step_number: 1,
...
async fn test_extension_event_subscription_automatic_conversion() {
    ...
    let test_events = vec![
        ...
        HeraMindEvent::RuleEvaluated {
            rule_id: "rule1".to_string(),
            rule_name: "Test Rule".to_string(),
            condition_met: true,
            timestamp: 0,
        },
        HeraMindEvent::AlertCreated {
        ...
        HeraMindEvent::LlmDecisionProposed {
        ...
        HeraMindEvent::ToolExecutionStart {
        ...
        HeraMindEvent::UserMessage {
            session_id: "session1".to_string(),
            content: "Test message".to_string(),
            timestamp: 0,
        },
        HeraMindEvent::Custom {
