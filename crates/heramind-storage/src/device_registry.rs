...
pub struct DeviceTypeTemplate {
    ...
    /// Older HeraMind builds set this when seeding built-in templates; the
...
/// Device configuration (simplified version matching heramind_devices::registry::DeviceConfig)
#[derive(Debug, Clone, Serialize, Deserialize, Default)]
