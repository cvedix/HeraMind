...
///
/// ```rust
/// use heramind_devices::image_storage::detect_extension;
///
...
///
/// ```rust
/// use heramind_devices::image_storage::validate_path_component;
///
...
///
/// ```no_run
/// use heramind_devices::image_storage::save_image_binary;
...
/// Read a HeraMind internal image URL (`/api/images/<dev>/<metric>/<ts>.<ext>`)
