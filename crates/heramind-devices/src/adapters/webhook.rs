//! Webhook device adapter for HeraMind event-driven architecture.
//!
            ...
            let core_value = match &value {
                ...
                MetricValue::Array(arr) => {
                    ...
                    let json_arr: Vec<serde_json::Value> = arr
                        ...
                        .collect();
                    heramind_core::MetricValue::Json(serde_json::json!(json_arr))
                }
                MetricValue::Binary(_) => heramind_core::MetricValue::Json(serde_json::json!(null)),
                MetricValue::Null => heramind_core::MetricValue::Json(serde_json::json!(null)),
            };
