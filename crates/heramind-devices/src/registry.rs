...
fn convert_connection_config(
    storage_config: heramind_storage::device_registry::ConnectionConfig,
) -> ConnectionConfig {
    ConnectionConfig {
...
) -> heramind_storage::device_registry::ConnectionConfig {
    heramind_storage::device_registry::ConnectionConfig {
    ...
    pub async fn load_from_storage(&self) -> Result<(), DeviceError> {
        ...
        for storage_template in storage_templates {
            ...
            let mode = match storage_template.mode {
                heramind_storage::device_registry::DeviceTypeMode::Simple => DeviceTypeMode::Simple,
                heramind_storage::device_registry::DeviceTypeMode::Full => DeviceTypeMode::Full,
            };
    ...
    pub async fn save_to_storage(&self) -> Result<(), DeviceError> {
        ...
        for entry in self.templates.iter() {
            ...
            let mode = match template.mode {
                DeviceTypeMode::Simple => heramind_storage::device_registry::DeviceTypeMode::Simple,
                DeviceTypeMode::Full => heramind_storage::device_registry::DeviceTypeMode::Full,
            };
