//! Clap command definitions shared between the \`heramind\` binary and the
...
/// HeraMind AI Agent - Run LLMs on edge devices.
#[derive(Parser, Debug)]
#[command(name = "heramind")]
...
pub enum ApiKeyCommand {
    ...
    /// Example: `heramind api-key create --name my-app`
    Create {
        /// Name for the key.
    ...
    /// Example: `heramind api-key delete my-app`
    Delete {
        /// Key name to delete.
        name: String,
        /// Data directory path.
...
pub enum LlmCommand {
    ...
    ///
    /// Example: `heramind llm get ollama-default`
    Get {
        /// Backend ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind llm delete my-llm`
    Delete {
        /// Backend ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind llm activate my-llm`
    Activate {
        /// Backend ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind llm test my-llm`
    Test {
        /// Backend ID.
        #[arg(required = true)]
        id: String,
...
pub enum ExtensionCommand {
    ...
    /// Example: `heramind extension validate ./my-extension.nep -v`
    Validate {
    ...
    /// Example: `heramind extension list -v`
    List {
    ...
    /// Example: `heramind extension get weather-forecast`
    ...
    /// Example: `heramind extension create my-extension --extension-type tool -o ./extensions`
    Create {
    ...
    /// Example: `heramind extension status weather-forecast`
    Status {
        /// Extension ID.
        #[arg(required = true)]
        id: String,
    ...
    /// Example: `heramind extension logs weather-forecast --lines 50`
    Logs {
        /// Extension ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    ///   Example: `heramind extension build ./extensions/weather-forecast`
    Build {
    ...
    /// Example: `heramind extension market-install weather-forecast --version 2.0.0`
    MarketInstall {
    ...
    /// Example: `heramind extension config weather-forecast`
    /// Example: `heramind extension config weather-forecast --set '{"city":"Beijing"}'`
    Config {
        /// Extension ID.
        #[arg(required = true)]
        id: String,
...
pub enum DeviceCommand {
    ...
    ///
    /// Example: `heramind device list --device-type temp_sensor --status online`
    List {
    ...
    /// Create a new device.
    ///
    /// First run `heramind device types list` to see available device types,
    /// or use any custom name. Default adapter is "mqtt".
    ///
    /// Workflow:
    ///   1. `heramind device types list` — pick a device type
    ///   2. `heramind device create --name "My Sensor" --device-type temp_sensor --adapter-type mqtt --id my-sensor-01`
    ...
    Create {
        ...
        #[arg(short, long)]
        name: String,
        /// Device type name. Run `heramind device types list` to see built-in types,
    ...
    ///
    /// Example: `heramind device update device-001 --name "Kitchen Sensor"`
    Update {
        /// Device ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind device delete device-001`
    Delete {
        /// Device ID.
        #[arg(required = true)]
        id: String,
    ...
    /// Check available commands first: `heramind device get <ID>` shows supported commands.
    ///
    /// Workflow:
    ...
    ///
    /// Example: `heramind device write-metric <ID> --metric temperature --value 25.5`
    WriteMetric {
        /// Device ID.
        #[arg(required = true)]
        id: String,
    ...
    /// Example: `heramind device webhook-url <ID>`
    WebhookUrl {
        /// Device ID.
        #[arg(required = true)]
        id: String,
...
pub enum DraftCommand {
    ...
    /// Example: `heramind device drafts get <DEVICE_ID>`
    Get {
    ...
    /// Example: `heramind device drafts approve <ID> --name "Temperature Sensor" --type temp_sensor`
    Approve {
        /// Device ID of the draft.
        #[arg(required = true)]
        id: String,
    ...
    /// Example: `heramind device drafts reject <ID>`
    Reject {
        /// Device ID of the draft.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind device drafts config --enabled true --auto-approve false`
    Config {
...
pub enum DeviceTypeCommand {
    ...
    ///
    /// Example: `heramind device types list`
    List,
    ...
    ///
    /// Example: `heramind device types get temp_sensor`
    Get {
        /// Type ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example:
    ///   heramind device types create --name "TempSensor" --metrics '[{"name":"temp","display_name":"Temperature","data_type":"Float","unit":"°C"}]'
    ///   heramind device types create --id temp_humidity --name "TempHumidity Sensor" --metrics '[{"name":"temp","display_name":"Temperature","data_type":"Float","unit":"°C"},{"name":"rh","display_name":"Humidity","data_type":"String","unit":"%"}]'
    Create {
    ...
    /// Check usage first: `heramind device list --device-type <type>`.
    ///
    /// Example: `heramind device types delete temp_sensor`
    Delete {
        /// Type ID.
        #[arg(required = true)]
        id: String,
...
pub enum DashboardCommand {
    ...
    /// Set `HERAMIND_JSON=1` for structured output.
    ///
    ...
    /// Use `HERAMIND_JSON=1` to get the exact format needed for `dashboard update --components`.
    ///
    ...
    ///
    /// Example: `heramind dashboard add-components <ID> --components '[{"id":"c1","type":"value-card",...}]'`
    AddComponents {
        /// Dashboard ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind dashboard remove-components <ID> --ids '["c1","c2"]'`
    RemoveComponents {
        /// Dashboard ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind dashboard delete dash-001`
    Delete {
        /// Dashboard ID.
        #[arg(required = true)]
        id: String,
    ...
    /// Example: `heramind dashboard share dash-001 --public=true --expires "2025-12-31"`
    Share {
        /// Dashboard ID.
        #[arg(required = true)]
        id: String,
...
pub enum RuleCommand {
    ...
    ///
    /// Example: `heramind rule get rule-001`
    Get {
        /// Rule ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind rule delete rule-001`
    Delete {
        /// Rule ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind rule enable rule-001`
    Enable {
        /// Rule ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind rule disable rule-001`
    Disable {
        /// Rule ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind rule test rule-001 --input '{"temperature": 32}'`
    Test {
        /// Rule ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind rule history rule-001`
    History {
        /// Rule ID.
        #[arg(required = true)]
        id: String,
...
pub enum TransformCommand {
    ...
    ///
    /// Example: `heramind transform list`
    List,
    ...
    ///
    /// Example: `heramind transform get transform-001`
    Get {
        /// Transform ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind transform update transform-001 --code 'return input * 2' --enabled true`
    Update {
        /// Transform ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind transform enable transform-001`
    Enable {
        /// Transform ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind transform disable transform-001`
    Disable {
        /// Transform ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind transform delete transform-001`
    Delete {
        /// Transform ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind transform metrics`
    Metrics,
    /// Test transform code.
    ///
    ...
    ///
    /// Example: `heramind transform test-code --code 'return input * 1.8 + 32' --input '{"value": 100}'`
    TestCode {
    ...
    /// Example: `heramind transform data-sources`
    DataSources,
}
...
pub enum AgentCommand {
    ...
    ///
    /// Example: `heramind agent get agent-001`
    Get {
        /// Agent ID.
        #[arg(required = true)]
        id: String,
    ...
    Create {
        ...
        /// LLM backend ID. Run `heramind system info` to see available backends.
        #[arg(short, long)]
    ...
    ///
    /// Example: `heramind agent update agent-001 --prompt "Monitor temperature and alert if above 30"`
    Update {
        /// Agent ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind agent delete agent-001`
    Delete {
        /// Agent ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind agent invoke agent-001 "Check all sensor readings"`
    Invoke {
        /// Agent ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind agent memory agent-001`
    Memory {
        /// Agent ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind agent clear-memory agent-001`
    ClearMemory {
        /// Agent ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind agent executions agent-001 --limit 10`
    Executions {
        /// Agent ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind agent latest-execution agent-001`
    LatestExecution {
        /// Agent ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind agent conversation agent-001 --limit 20`
    Conversation {
        /// Agent ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind agent send-message agent-001 "Increase alert threshold to 35"`
    SendMessage {
        /// Agent ID.
        #[arg(required = true)]
        id: String,
...
pub enum MessageCommand {
    ...
    ///
    /// Example: `heramind message list --severity critical --limit 50`
    List {
        /// Limit number of results.
        #[arg(short, long)]
        limit: Option<usize>,
    ...
    ///
    /// Example: `heramind message get msg-001`
    Get {
        /// Message ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind message send --title "Deploy Notice" --body "Version 2.0 deployed" --severity info`
    Send {
        /// Message title.
        #[arg(short, long)]
        title: String,
    ...
    ///
    /// Example: `heramind message read msg-001`
    ...
    /// Example: `heramind message channel-list`
    ChannelList,
    /// Get channel details.
    ///
    /// Shows channel type, config, and delivery status.
    /// Example: `heramind message channel-get slack-alerts`
    ChannelGet {
        /// Channel name.
        #[arg(required = true)]
        name: String,
    ...
    /// Example: `heramind message channel-types`
    ChannelTypes,
    ...
    /// Example: `heramind message channel-type-schema telegram`
    ChannelTypeSchema {
    ...
    /// Example: `heramind message channel-update --name "alerts" --config '{"url":"https://new-url.com"}'`
    ChannelUpdate {
        /// Channel name.
        #[arg(long)]
        name: String,
    ...
    /// Example: `heramind message channel-delete slack-alerts`
    ChannelDelete {
        /// Channel name.
        #[arg(required = true)]
        name: String,
    ...
    /// Example: `heramind message channel-test slack-alerts`
    ChannelTest {
        /// Channel name.
        #[arg(required = true)]
        name: String,
...
pub enum PushCommand {
    ...
    ///   mqtt:    '{"broker":"tcp://broker:1883","topic":"heramind/data","username":"user","password":"pass"}'
    ///
    /// Example: `heramind push create --name my-webhook --type webhook --config '{"url":"https://httpbin.org/post"}'`
    Create {
    ...
    /// Example: `heramind push update <ID> --config '{"url":"https://new-url.com"}'`
    Update {
        /// Target ID.
        #[arg(required = true)]
        id: String,
    ...
    /// Example: `heramind push delete <ID>`
    Delete {
        /// Target ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind push enable <ID>`
    Enable {
        /// Target ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind push disable <ID>`
    Disable {
        /// Target ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind push logs <ID> --limit 20`
    Logs {
        /// Target ID.
        #[arg(required = true)]
        id: String,
...
pub enum WidgetCommand {
    ...
    /// Example: `heramind widget get line-chart`
    Get {
        /// Widget ID.
        #[arg(required = true)]
        id: String,
    ...
    /// Example: `heramind widget bundle line-chart`
    Bundle {
        /// Widget ID.
        #[arg(required = true)]
        id: String,
    ...
    /// Example: `heramind widget create "My Chart" --widget-type chart -o ./my-widgets`
    Create {
        /// Widget display name.
        #[arg(required = true)]
        name: String,
    ...
    /// Example: `heramind widget uninstall my-chart`
    Uninstall {
        /// Widget ID.
        #[arg(required = true)]
        id: String,
    ...
    /// Example: `heramind widget market-install line-chart --version 1.2.0`
    MarketInstall {
        /// Widget ID.
        #[arg(required = true)]
        id: String,
...
pub enum SettingsCommand {
    ...
    /// Example: `heramind settings set-retention --enabled --interval-hours 1 --default-retention 168`
    SetRetention {
...
pub enum ConnectorCommand {
    ...
    /// Example: `heramind connector get connector-001`
    Get {
        /// Connector ID.
        #[arg(required = true)]
        id: String,
    ...
    ///   3. Devices sending to the connector's topics will auto-appear in HeraMind
    ///
    ///   Example: `heramind connector create --type mqtt --name "Factory MQTT" --host 192.168.1.100 --port 1883 --topics "sensor/#,device/#"`
    Create {
    ...
    /// Example: `heramind connector update connector-001 --topics "sensor/+/data" --password "newpass"`
    Update {
        /// Connector ID.
        #[arg(required = true)]
        id: String,
    ...
    /// Example: `heramind connector delete connector-001`
    Delete {
        /// Connector ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind connector enable connector-001`
    Enable {
        /// Connector ID.
        #[arg(required = true)]
        id: String,
    ...
    ///
    /// Example: `heramind connector disable connector-001`
    Disable {
        /// Connector ID.
        #[arg(required = true)]
        id: String,
    ...
    /// Example: `heramind connector test connector-001`
    Test {
        /// Connector ID.
        #[arg(required = true)]
        id: String,
    ...
    /// Example: `heramind connector subscribe --topic "factory/+/temperature" --qos 1`
    Subscribe {
    ...
    /// Example: `heramind connector unsubscribe --topic "factory/+/temperature"`
    Unsubscribe {
...
mod unify_enable_disable_tests {
    ...
    fn parse(argv: &str) -> Command {
        ...
        Args::try_parse_from(["heramind"].into_iter().chain(argv.split_whitespace()))
            .unwrap()
            .command
    }
