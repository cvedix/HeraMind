...
use heramind_agent::toolkit::{FileEditTool, FileWriteTool, Tool, ToolOutput, WebFetchTool};
...
fn assert_success(result: Result<ToolOutput, heramind_agent::toolkit::ToolError>) -> ToolOutput {
...
fn assert_failure(result: Result<ToolOutput, heramind_agent::toolkit::ToolError>) {
    match result {
