...
use heramind_agent::toolkit::registry::ToolCall;
use heramind_agent::toolkit::{Result as ToolResult, Tool, ToolError, ToolOutput, ToolRegistry};
...
///
/// Run with: `cargo test -p heramind-agent --test cancellation_test -- --ignored`
///
/// Expected behavior:
