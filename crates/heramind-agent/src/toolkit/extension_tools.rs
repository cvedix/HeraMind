...
use heramind_core::extension::{DynExtension, ExtensionCommand};
...
mod tests {
    ...
    fn test_normalize_image_args_resolves_api_images_url() {
        ...
        // at their boundaries.
        let temp =
            std::env::temp_dir().join(format!("heramind_test_ext_tool_{}", uuid::Uuid::new_v4()));
