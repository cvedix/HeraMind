...
// Re-exports from heramind_core
pub use heramind_core::llm::compaction::{CompactionConfig, MessagePriority};
...
mod tests {
    ...
    async fn test_pure_content_stream() {
        ...
        assert_eq!(full_content, "你好，我是HeraMind助手。");
