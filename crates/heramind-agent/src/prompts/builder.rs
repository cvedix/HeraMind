//! Prompt generation utilities for the HeraMind AI Agent.
//!
//! ## Architecture
//!
//! Three-layer documentation:
//! 1. System prompt (~2,000 tokens) — core decision rules, always loaded
//! 2. CLI `--help` — command details, loaded on demand by LLM running `heramind <cmd> --help`
...
mod tests {
    ...
    fn test_prompt_builder_default() {
        ...
        assert!(prompt.contains("HeraMind"));
