...
//!
//! ```rust,no_run
//! use heramind_agent::{SessionManager, AgentConfig};
//!
//! #[tokio::main]
...
pub mod image_utils;
pub mod llm;
pub mod llm_backends; // Merged from heramind-llm crate
pub mod memory;
pub mod prompts;
pub mod session;
pub mod skills;
...
pub use error::{HeraMindError, Result};
pub use session::{CreateSessionOptions, SessionManager};

// Re-export llm_backends types for backward compatibility (merged from heramind-llm crate)
