...
//!
//! ```rust,no_run
//! use heramind_rules::{RuleEngine, CompiledRule};
//! use heramind_rules::models::*;
//!
//! #[tokio::main]
//! async fn main() -> Result<(), Box<dyn std::error::Error>> {
//!     let provider = std::sync::Arc::new(heramind_rules::InMemoryValueProvider::new());
...
//!         source: heramind_core::datasource::DataSourceId::device("sensor1", "temperature"),
