...
function createSystemDS(metric: string): DataSource {
  return { type: 'system', systemMetric: metric as any, refresh: DEFAULT_REFRESH, source: 'system', id: 'heramind', field: metric, mode: 'latest' }
}
        ...
        return (
          <div className="space-y-1">
            {getSystemMetrics(t).map(metric => {
              const metricIsSelected = isSelected('system', 'heramind', metric.id)
