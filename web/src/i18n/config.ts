...
import vi_alerts from './locales/vi/alerts.json';
import vi_automation from './locales/vi/automation.json';
import vi_plugins from './locales/vi/plugins.json';
import vi_extensions from './locales/vi/extensions.json';
...
import vi_agents from './locales/vi/agents.json';
import vi_dashboard_components from './locales/vi/dashboard-components.json';
import vi_chat from './locales/vi/chat.json';
import vi_setup from './locales/vi/setup.json';
import vi_data from './locales/vi/data.json';
import vi_instances from './locales/vi/instances.json';
import vi_ui from './locales/vi/ui.json';
...
const resources = {
  ...
  vi: {
    ...
    devices: vi_devices,
    alerts: vi_alerts,
    automation: vi_automation,
    plugins: vi_plugins,
    extensions: vi_extensions,
    settings: vi_settings,
    auth: vi_auth,
    validation: vi_validation,
    dashboard: vi_dashboard,
    agents: vi_agents,
    dashboardComponents: vi_dashboard_components,
    chat: vi_chat,
    setup: vi_setup,
    data: vi_data,
    instances: vi_instances,
    ui: vi_ui,
  },
};
