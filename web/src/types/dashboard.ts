/**
 * Dashboard type definitions for HeraMind
 *
 * Two-layer component system:
 * - Generic Components: Reusable IoT/dashboard components
 * - Business Components: HeraMind-specific components
 */
...
export function migrateToUnified(ds: DataSource): DataSource {
  ...
  switch (ds.type) {
    ...
    case 'system':
      m.source = 'system'; m.id = 'heramind'; m.field = ds.systemMetric; m.mode = 'latest'; break
    case 'transform':
 ...
 * HeraMind-specific business components
 */
