 ...
 */
export const selectDevicesRaw = (state: HeraMindStore): Device[] => state.devices
 ...
 */
export const selectOnlineDevices = (state: HeraMindStore): Device[] =>
 ...
 * Memoized - only recomputes when devices array changes
 */
export const selectOfflineDevices = (state: HeraMindStore): Device[] =>
 ...
 * Memoized - only recomputes when devices array changes
 */
export const selectDevicesByType = (state: HeraMindStore, deviceType: string): Device[] =>
 ...
 */
export const selectDeviceById = (state: HeraMindStore, deviceId: string): Device | undefined =>
 ...
 */
export const selectDeviceMap = (state: HeraMindStore): Map<string, Device> => {
 ...
 */
export const selectOnlineDeviceCount = (state: HeraMindStore): number =>
  state.devices.filter((d) => d.status === 'online').length

/**
 * Get count of offline devices
 */
export const selectOfflineDeviceCount = (state: HeraMindStore): number =>
  state.devices.filter((d) => d.status === 'offline').length

/**
 * Get total device count
 */
export const selectTotalDeviceCount = (state: HeraMindStore): number =>
 ...
 */
export const selectDevicesByStatus = (state: HeraMindStore) => {
  const online: Device[] = []
 ...
 */
export const selectDevicesGroupedByType = (state: HeraMindStore): Record<string, Device[]> => {
 ...
 */
export const selectDevicesShallow = (state: HeraMindStore) => state.devices
 ...
 */
export const selectDevicesSummary = (state: HeraMindStore) => ({
