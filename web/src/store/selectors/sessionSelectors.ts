 ...
 * Get all sessions
 */
export const selectSessionsRaw = (state: HeraMindStore): ChatSession[] => state.sessions
 ...
 */
export const selectActiveSession = (state: HeraMindStore): ChatSession | undefined =>
  state.sessions.find((s) => s.id === state.sessionId)

/**
 * Get active session ID
 */
export const selectActiveSessionId = (state: HeraMindStore): string | null =>
  state.sessionId
 ...
 * Get session by ID
 */
export const selectSessionById = (state: HeraMindStore, sessionId: string): ChatSession | undefined =>
  state.sessions.find((s) => s.id === sessionId)

/**
 * Get sessions as a Map for O(1) lookups
 */
export const selectSessionMap = (state: HeraMindStore): Map<string, ChatSession> => {
 ...
 */
export const selectSessionsByRecent = (state: HeraMindStore): ChatSession[] => {
 ...
 */
export const selectSessionsByNewest = (state: HeraMindStore): ChatSession[] => {
 ...
 */
export const selectSessionsByName = (state: HeraMindStore): ChatSession[] => {
  return [...state.sessions].sort((a, b) =>
 ...
 * Get session count
 */
export const selectSessionCount = (state: HeraMindStore): number =>
  state.sessions.length

/**
 * Get sessions grouped by date (today, this week, this month, older)
 */
export const selectSessionsGroupedByDate = (state: HeraMindStore) => {
  const now = Date.now()
 ...
 */
export const selectSessionsSummary = (state: HeraMindStore) => {
 ...
 */
export const selectSessionsBySearchTerm = (state: HeraMindStore, searchTerm: string): ChatSession[] => {
  if (!searchTerm.trim()) {
 ...
 */
export const selectSessionsWithMessages = (state: HeraMindStore, minMessages: number = 1): ChatSession[] =>
