...
<p align="center">
  <a href="https://github.com/CVEDIX/HeraMind/actions/workflows/build.yml">
...
> 📚 **完整文档已迁移至 [HeraMind 文档](https://docs.cvedix.com/heramind)。** 本 README 仅作快速概览，详细指南请访问文档：
>
> - [HeraMind 是什么？](https://docs.cvedix.com/heramind) — 产品概览与核心理念
> - [五分钟快速开始](https://docs.cvedix.com/heramind) — 快速上手
> - [安装与配置](https://docs.cvedix.com/heramind) — 桌面端、服务器、Docker 部署
> - [开发者指南](https://docs.cvedix.com/heramind) — API、扩展、集成
...
HeraMind 是一个模块化的生态系统，每个关注点都有专门的资源：

| 资源 | 用途 |
|------|------|
| **[HeraMind](https://github.com/CVEDIX/HeraMind)** | 核心平台（本仓库）— 后端、前端、桌面应用 |
| **[扩展文档](https://docs.cvedix.com/heramind)** | 官方扩展市场 — 天气、YOLO 检测、OCR、人脸识别、视频流 |
| **[设备类型文档](https://docs.cvedix.com/heramind)** | 设备类型定义 — 标准化的 IoT 硬件指标和命令 |
| **[仪表板组件文档](https://docs.cvedix.com/heramind)** | 仪表板组件市场 — 社区贡献的 React 组件 |
...
NE301（边缘 AI 摄像头）和 NE101（感知摄像头）。完整设备类型定义请查看 [设备类型文档](https://docs.cvedix.com/heramind)。

### 参与生态共建

我们欢迎社区贡献，共同丰富 HeraMind 生态系统：

- **[开发扩展](https://docs.cvedix.com/heramind)** — 为新的数据源、AI 模型或集成创建扩展。参考 [开发者指南](https://docs.cvedix.com/heramind) 快速上手，然后向市场提交 PR。
- **[添加设备类型](https://docs.cvedix.com/heramind)** — 为你的 IoT 硬件定义指标和命令，让其他人开箱即用。只需添加一个 JSON 文件。
- **[创建仪表板组件](https://docs.cvedix.com/heramind)** — 构建可复用的 React 仪表板组件（图表、仪表盘、地图等），与社区分享。

## 快速开始

> 完整流程请参考文档中的 [五分钟快速开始](https://docs.cvedix.com/heramind) 和 [安装与配置](https://docs.cvedix.com/heramind)。

### 桌面应用（推荐）

从 [GitHub Releases](https://github.com/CVEDIX/HeraMind/releases/latest) 下载最新版本。
...
**指定版本：**
```bash
curl -fsSL https://raw.githubusercontent.com/CVEDIX/HeraMind/main/scripts/install.sh | VERSION=0.8.11 sh
```
...
详见 [开发者指南](https://docs.cvedix.com/heramind) 和 [HeraMind 文档](https://docs.cvedix.com/heramind)。

## 文档

所有用户、安装和开发文档均位于 **[HeraMind 文档](https://docs.cvedix.com/heramind)**：

| 文档板块 | 内容 |
|----------|------|
| [产品概览](https://docs.cvedix.com/heramind) | HeraMind 是什么、核心概念、架构 |
| [快速开始](https://docs.cvedix.com/heramind) | 五分钟跑起第一个实例 |
| [安装与配置](https://docs.cvedix.com/heramind) | 桌面端、服务器、Docker、配置 |
| [开发者指南](https://docs.cvedix.com/heramind) | REST/WebSocket API、扩展、集成 |
